...
const routes = [
    {
        ...
        children: [
            {
                path: 'home',
                loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_feature_home_home_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ../home/home.module */ 96260)).then((m) => m.HomePageModule),
            },
            {
                path: 'asesora',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_feature_asesora_asesora_module_ts-src_app_shared_constants_endPoint_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../asesora/asesora.module */ 3183)).then((m) => m.AsesoraPageModule),
            },
            {
                path: 'schedule',
                loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_sweetalert2_dist_sweetalert2_all_js-src_app_shared_constants_endPoint_ts"), __webpack_require__.e("common"), __webpack_require__.e("src_app_feature_schedule_schedule_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ../schedule/schedule.module */ 2233)).then((m) => m.SchedulePageModule),
            },
            // {
            // 	path: '',
